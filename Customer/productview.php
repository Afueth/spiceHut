...
include("config.php");
?>
<form action="" style="padding-top: 7%;background-image:url(images/a9.jpg)">
  <div class="container" style="margin-left:124px; margin-bottom:5%;padding-left:-25px; box-shadow: 2px 2px 10px #000000; border-radius: 4px; top: 14px;padding-top:5%;">
    ...
    <div class="row" style="min-height: 80%;">
     ...
     while($row=mysqli_fetch_array($result))
							{
								?>
      <div class="col-md-4" style="box-shadow: 3px 3px 10px #000; border-radius: 10px; top: 34px;width: 260px;height:439px;background-color: white;color: white;margin-left:7%;;margin-top:8%;margin-bottom:15%;margin-right:6px%;"> <?php echo "<a style='color:#090' href='Productviewmore.php?p_id=".$row['product_id']."'>";?>

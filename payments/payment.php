									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                      ...
                                      <form action="paymentsave.php" method="post">
											...
											<h3 class="pay-title">Credit Card Info</h3>
												...
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
													 <input type="text" name="txtqty" id="txtqty" value=""  class="form-control" style="width: 201px;" autofocus required/>
													<h5>CARD NUMBER</h5>													
														 <input type="tel" name="txtqty" id="txtqty" value=""  class="form-control" pattern="[0-9]{16}" required style="    width: 96%;"  placeholder="0000-0000-0000-0000"/>
												</div>	

...
<div class="main-top" id="home">
      ...
      <div class="container">
        ...
        <div class="outs_more-buttn mt-md-4 mt-3">
          <a href="#great-deals">View Spices</a>
        </div>
      </div>
    </div>
  </div>
...
<form id="great-deals" style="padding-top: 7%;">
  <div class="container" >
    <h2 style="text-align: center;margin-left: 1%;margin-bottom: -8%;margin-top: -5%;font-family: fantasy;">Great Deals!!!</h2>
    <br>
